...
public class newDatabaseTest : MonoBehaviour
{
    ...
    void Start()
    {
        reference = FirebaseDatabase.DefaultInstance.GetReferenceFromUrl("https://unity-game-767f2-default-rtdb.firebaseio.com/");
    ...
    public void LoadData()
    {
      ...
      reference.GetValueAsync().ContinueWith(task => {
        ...
        FirebaseDatabase.DefaultInstance.GetReferenceFromUrl("");
